...
impl AetherRuntime {
    ...
    pub fn new() -> Self {
        ...
        // Local-first: always available without secrets.
        ...
        // Titan — fine-tuning, tokenization, and experiment platform.
        manager.register(TitanProvider::new(None));

        // Cloud: only when a key is configured (keeps health checks honest).
